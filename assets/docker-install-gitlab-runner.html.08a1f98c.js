import{_ as i,r,o as l,c,b as n,d as s,a as e,e as t}from"./app.8bbedbe7.js";const o={},p=t(`<h1 id="docker安装gitlab-runner" tabindex="-1"><a class="header-anchor" href="#docker安装gitlab-runner" aria-hidden="true">#</a> docker安装gitlab-runner</h1><div class="custom-container tip"><p class="custom-container-title">提示</p><p>理想情况下，不应将GitLab Runner与GitLab安装在同一台机器上。</p></div><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull gitlab/gitlab-runner
