import{_ as a,r as e,o as t,c as l,b as n,d as i,a as p,e as c}from"./app.8bbedbe7.js";const o={},u=c(`<h1 id="网络配置" tabindex="-1"><a class="header-anchor" href="#网络配置" aria-hidden="true">#</a> 网络配置</h1><h2 id="未显示声明" tabindex="-1"><a class="header-anchor" href="#未显示声明" aria-hidden="true">#</a> 未显示声明</h2><p>docker-compose中未显式声明，会生成默认的网络</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&quot;3.4&quot;</span>
