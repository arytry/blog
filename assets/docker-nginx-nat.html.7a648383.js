import{_ as a,r as e,o,c as t,b as n,d as i,a as c,e as p}from"./app.521b9759.js";const l={},r=p(`<h1 id="docker-nginx添加端口映射" tabindex="-1"><a class="header-anchor" href="#docker-nginx添加端口映射" aria-hidden="true">#</a> docker nginx添加端口映射</h1><div class="custom-container tip"><p class="custom-container-title">提示</p><p><strong>一般我们通过docker运行nginx容器的时候，都只会将<code>80</code>或者<code>443</code>端口映射到宿主机，因为不知道后期在实现反向代理的时候具体会指定什么端口号，所以大部分时候会在后期修改端口映射</strong></p></div><p>假如在运行容器时执行的命令如下</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># -p 80:80  端口映射：容器80端口映射到宿主机的80端口</span>
